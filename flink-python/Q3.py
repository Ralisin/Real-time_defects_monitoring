...
class OutlierClustering(MapFunction):
    def __init__(self, eps=20, min_samples=5):
        self.eps = eps
    ...
    def map(self, value):
        ...
        try:
            print(f"[OutlierClustering] seq_id: {seq_id}, print_id: {print_id}, tile_id: {tile_id}, saturated: {saturated_count}, outlier_points len: {len(outlier_points)}")
